...
- Добавили инструменты odata_query и odata_setup для данных базы через OData


### Исправления

- Уложили большие данные команды в ответ агенту

- Убрали совет wait: true из ответа команд, которые не возвращают исход

- Исправили искажение русских букв в длинных ответах расширения


### Документация

- Описали параметры и примеры инструментов OData
...
- Добавили инструменты списка проектов, переключения текущего проекта и инициализации проекта


### Исправления

- **tools:** Параметры отбора и запуска доходят до нужных команд


### Документация

- Описали MCP-сервер для сайта расширения и убрали каталоги исходного кода из параметров

- Обновили таблицы примеров в документации для улучшения читаемости

- Добавили раздел о работе с несколькими окнами в документации


### Обслуживание

- Просим сайт расширения пересобраться после правок документации

- **release:** Перевели публикацию в маркетплейсы на vsce и ovsx
